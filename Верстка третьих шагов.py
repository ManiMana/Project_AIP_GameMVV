...
#         continue_text = self.font.render("Нажмите 'Enter' для продолжения", True, (0, 0, 0))
...
#         exit_button_rect = pygame.Rect(20, button_y, button_width, button_height)
#         pygame.draw.rect(self.screen, (205, 231, 238), exit_button_rect)
...
#         delete_button_rect = pygame.Rect(20, button_y + button_height + 10, button_width, button_height)
