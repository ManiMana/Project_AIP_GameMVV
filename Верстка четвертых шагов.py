    ...
    def __init__(self):
        ...
        self.icons = {
            "Здоровье": {
                ...
                "middle": pygame.transform.scale(pygame.image.load("health_middle.png"), (70, 70)),  # Новая иконка
            ...
            "Голод": {
                ...
                "middle": pygame.transform.scale(pygame.image.load("hunger_middle.png"), (70, 70)),  # Новая иконка
            ...
            "Счастье": {
                ...
                "middle": pygame.transform.scale(pygame.image.load("happiness_middle.png"), (70, 70)),  # Новая иконка
            ...
            "Чистота": {
                ...
                "middle": pygame.transform.scale(pygame.image.load("clean_middle.png"), (70, 70)),  # Новая иконка
            ...
            "Сон": {
                ...
                "middle": pygame.transform.scale(pygame.image.load("sleep_middle.png"), (70, 70)),  # Новая иконка
    ...
    def draw(self):
        ...
        for i, (stat, value) in enumerate(self.stats.items()):
            if value >= 68:
                ...
                icon = self.icons[stat]["middle"]  # Используйте иконку "middle"
            else:
